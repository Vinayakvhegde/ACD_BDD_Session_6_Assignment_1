...
Job job = new Job(conf, "Assignment 1 :Olympic Swimming List");
job.setJarByClass(OlympicSwimList.class);
...
System.exit(job.waitForCompletion(true) ? 0 : 1);
	...
	public static class TokenizerMapper 
		...
		public void map(Object key, Text value,	Mapper<Object, Text, Text, LongWritable>.Context context)
			...
			if (parts[CDRConstants.sport].equalsIgnoreCase("Swimming")) {
				countryName.set(parts[CDRConstants.country]);
				totalMedals.set(Long.parseLong(parts[CDRConstants.totalMedals]));
				context.write(countryName, totalMedals);
			}
		}
	}
